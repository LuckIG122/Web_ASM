...
//------------------------------LOGIN FORM-------------------------------
    const loginForm = document.querySelector(".form-signin-signup");
    if (loginForm) {
    ...
    //------------------------------SIGNUP FORM-------------------------------
    const signupForm = document.querySelector(".form-signin-signup");
    if (signupForm) {
...
// Đảm bảo phần login và signup dùng xác thực như trên, lưu username là user.name
});
